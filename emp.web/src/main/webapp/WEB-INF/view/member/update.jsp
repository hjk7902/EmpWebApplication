...
<div class="container">
	...
	<div class="content">
	<form action="<c:url value='/member?update'/>" method="post" class="form-horizontal">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" for="address"><fmt:message key="MEMBER_EMAIL"/></label>
      <div class="col-sm-8">
